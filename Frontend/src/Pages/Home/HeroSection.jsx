...
const HeroSection = () => (
  // <section className="bg-[#e7f7fe] relative overflow-hidden min-h-screen flex items-center justify-center">
  //   <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-2 md:px-20 lg:gap-10">
  ...
  //       <div className="flex items-center justify-center  lg:w-[45vh] sm:w-[15rem]">
  //         <img
  //           src="../assets/456.png"
  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-2 md:px-20 lg:gap-10">
    <div className="flex-1 mb-10 md:mb-0 md:mr-20 p-5">
      <h1 className="text-3xl md:text-5xl lg:text-5xl font-bold text-[#2d2350] mb-4 leading-tight">
        Consult a doctor anytime, anywhere <br className="hidden md:block" />
        <span className="text-sky-600">by video call</span>
      </h1>
      <p className="text-gray-600 text-base md:text-lg mb-6 max-w-xl">
