...
// const HeroSection = () => (
//     <section className="bg-[#e7f7fe] relative overflow-hidden min-h-[calc(100vh-4rem)] flex items-center justify-center">
//     <div className="max-w-[100rem] mx-auto flex flex-col md:flex-row items-center px-2 lg:px-20 md:px-10 lg:gap-0">
//       <div className="flex-1 mb-10 md:mb-0 md:mr-0 p-5">
//         <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold text-[#2d2350] mb-4 leading-tight">
  ...
  return (
    <section className="bg-[#e7f7fe] relative overflow-hidden min-h-[calc(100vh-4rem)] flex items-center justify-center">
      <div className="max-w-[100rem] mx-auto flex flex-col md:flex-row items-center px-2 lg:px-20 md:px-10 lg:gap-0">
        {/* Left Content */}
        <div
          className={`flex-1 mb-10 md:mb-0 md:mr-0 p-5 transition-all duration-1000 ease-out
        ...
        {/* Right Image */}
        <div
          className={`flex-1 flex justify-end items-center h-full transition-all duration-1000 ease-out
            ${showContent ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}
          `}
        >
          <div className="flex items-center justify-end lg:w-[55vh] md:w-[20rem] sm:w-[15rem]">
