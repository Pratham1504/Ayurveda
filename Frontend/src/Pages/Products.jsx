...
const Products = () => {
  ...
  return (
    <div className="font-sans container px-4 mx-auto max-w-screen-xl lg:py-10 lg:px-6 text-black lg:max-w-3/4 lg:mx-auto">
      <h1 className="text-4xl font-semibold text-center mb-10 text-black mt-6 sm:mt-0">
        Browse Our Products
      </h1>
                ...
                >
                  ...
                  <div className="flex justify-center items-center mb-4 h-44 relative">
                    ...
                    <img
                      ...
                      alt="Website Logo"
                      className="absolute bottom-2 right-2 w-8 h-8 object-contain opacity-90 pointer-events-none z-20"
                      draggable={false}
                    />
                  </div>
