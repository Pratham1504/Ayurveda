...
//     return (
//         <section className="bg-gradient-to-br from-white to-sky-50 py-8 sm:py-10 px-4 sm:px-6 mx-auto rounded-3xl shadow-xl border border-gray-100 transition-all duration-300 ease-in-out lg:max-w-3/4">
...
const Appointment = () => {
    ...
    const renderAppointmentCard = (appointment) => {
        ...
        return (
            <motion.div
                ...
                className="rounded-2xl bg-white shadow-xl border border-sky-100 p-6 mb-4 hover:shadow-2xl transition-shadow"
            >
                ...
                {appointment.communication_mode === 'gmeet' && appointment.status === 'confirmed' && appointment.gmeet_link && (
                    <p className="mt-4 text-sm flex items-center gap-1">
                        <LinkIcon className="w-4 h-4 text-blue-500" />
                        <a href={appointment.gmeet_link} target="_blank" rel="noreferrer" className="text-blue-600 underline font-medium">
                            Join Meet
                        </a>
                    </p>
                )}
    ...
    const AppointmentSkeleton = () => (
        <div className="rounded-2xl bg-white shadow-xl border border-sky-100 p-6 mb-4 animate-pulse">
            <div className="grid grid-cols-2 gap-4 text-sm text-gray-700">
                {[...Array(4)].map((_, i) => (
                    <div key={i}>
                        <div className="h-4 w-24 bg-sky-200 rounded mb-1" />
    ...
    return (
        <section className="bg-gradient-to-br from-white to-sky-50 py-10 px-2 sm:px-8 mx-auto rounded-3xl shadow-2xl border border-gray-100 transition-all duration-300 ease-in-out max-w-3xl mt-8 mb-12">
            <Toaster />
            <motion.h2
                initial={{ opacity: 0, y: -30 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.7 }}
                className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center text-sky-700 mb-12 tracking-tight"
            >
            ...
            <motion.form
                ...
                className="space-y-8 bg-white/80 rounded-2xl shadow-lg p-6 sm:p-10 border border-sky-100"
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="relative hover:scale-[1.01] transition-transform duration-200 ease-in-out">
                        ...
                        <input
                            ...
                            placeholder="Enter your full name"
                            required
                            className="w-full pl-10 p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-sky-300 bg-white"
                        />
                    </div>
                    ...
                    <div className="hover:scale-[1.01] transition-transform duration-200 ease-in-out">
                        ...
                        <input
                            ...
                            placeholder="Enter your age"
                            required
                            className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-sky-300 bg-white no-spinner"
                        />
                    </div>
                    ...
                    <div className="hover:scale-[1.01] transition-transform duration-200 ease-in-out">
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            required
                            className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-sky-300 bg-white"
                        >
                            <option value="" disabled>Select a time</option>
                            <option value="morning">Morning</option>
                            <option value="evening">Evening</option>
