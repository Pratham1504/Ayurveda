...
// import { UserData } from '../Context/UserContext'; // Import your context hook


// const Navbar = () => {
//   const [isOpen, setIsOpen] = useState(false);

//   const { isAuth } = UserData(); // Get isAuth from context
...
//             </div>
//             ) : (
//               <div className='cart-user-logout flex items-center gap-4'>
//                 <div>
...
//                 </div>
//                 <div>
//                   <a href="/logout" className="hidden md:inline-block bg-sky-600 text-white px-4 py-2 rounded-md hover:bg-sky-700 transition duration-200 ml-10">
//                     Logout
//                   </a>
//                 </div>
//               </div>
...
const Navbar = () => {
  ...
  const { isAuth, loginUser, registerUser, verifyOtp, btnLoading } = UserData();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-around h-16 ">
          <div className="w-full items-center flex justify-between ">
            ...
            {!isAuth ? (
              <button
                onClick={() => { setModalIsOpen(true); setIsLogin(true); }}
              ...
              <div className='cart-user-logout flex items-center gap-4 ml-10'>
                ...
                <div>
                  <a href="/logout" className="hidden md:inline-block bg-sky-600 text-white px-4 py-2 rounded-md hover:bg-sky-700 transition duration-200">
                    Logout
                  </a>
                </div>
              </div>
